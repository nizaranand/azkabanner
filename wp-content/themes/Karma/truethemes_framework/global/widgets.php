...
class SocialMediaWidget extends WP_Widget {
	...
	function SocialMediaWidget() {
		$widget_ops = array('classname' => 'social_widget', 'description' => __('Link to your RSS feed and social media accounts.','truethemes'));
		$this->WP_Widget('social_networks', __('CUSTOM - Social Networks','truethemes'), $widget_ops);
	}
...
?>
    	...
    	<p><label for="<?php echo $this->get_field_id('title_link'); ?>"><?php _e('Title link:','truethemes'); ?></label>     
    	<?php wp_dropdown_pages(array('selected' => $title_link, 'name' => $this->get_field_name('title_link'), 'show_option_none' => __('None','truethemes'), 'sort_column'=> 'menu_order, post_title'));?>
   		 </p>
		
		<p><label for="<?php echo $this->get_field_id('rss'); ?>"><?php _e('RSS URL: (leave empty for default feed)','truethemes'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('facebook'); ?>"><?php _e('Facebook URL:','truethemes'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('twitter'); ?>"><?php _e('Twitter URL:','truethemes'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('flickr'); ?>"><?php _e('Flickr URL:','truethemes'); ?></label>
        ...
        <p><label for="<?php echo $this->get_field_id('youtube'); ?>"><?php _e('Youtube URL:','truethemes'); ?></label>
        ...
        <p><label for="<?php echo $this->get_field_id('linkedin'); ?>"><?php _e('LinkedIn URL:','truethemes'); ?></label>
        ...
        <p><label for="<?php echo $this->get_field_id('foursquare'); ?>"><?php _e('FourSquare URL:','truethemes'); ?></label>
        ...
        <p><label for="<?php echo $this->get_field_id('delicious'); ?>"><?php _e('Delicious URL:','truethemes'); ?></label>
        ...
        <p><label for="<?php echo $this->get_field_id('digg'); ?>"><?php _e('Digg URL:','truethemes'); ?></label>
